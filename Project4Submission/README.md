...
Some merges were not automatic with manual commits happening as needed due to technical issues.

Our tasks were divided using the online App "Trello" in order to keep track of our individual tasks.

GitHub repo: https://github.com/CamRock89/webgl-rollercoaster-simulator/

This README.md is here to document who worked on what component and when (written by Devin :) ).

Devin:
a. Phong lighting model implementation

b. Noon sunlight positioning
c. Skybox with color interpolation
d. Water wave animation with bump mapping and reflection of the overhead skybox

Anthony:
a. Terrain generation

b. Skybox and pondbed
c. Trees, rocks, and houses
...
Phase 2: Devin's phong lighting model, skybox interpolation, water wave animation, bump mapping, and reflection work.
Phase 3: Cameron's refined camera system and track improving on the original implementation.
