...
function buildRollerCoasterTrack()
{
    ...
    var trackColor = vec4(0.5, 0.25, 0.1, 1.0);
...
function getCameraMatrix()
{
    if (cameraMode === "auto")
    {
        ...
        var autoEye = vec3(current[0], current[1] + 0.6, current[2]);

        var autoAt = vec3(next[0], next[1] + 0.6, next[2]);
